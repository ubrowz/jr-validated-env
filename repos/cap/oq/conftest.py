"""
Cap module OQ test suite — shared configuration and helpers.

All Cap test modules import helpers from this file.
"""
...
MODULE_ROOT  = os.path.dirname(OQ_DIR)                        # repos/cap/
...
def extract_float(result, label):
    ...
    *label* should include any trailing colon, e.g. ``"Cpk:"``.
